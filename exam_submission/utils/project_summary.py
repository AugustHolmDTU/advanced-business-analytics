...
def expected_daily_profile(env_cfg: dict[str, Any], steps_per_day: int = 288) -> pd.DataFrame:
    ...
    # this is just a smooth sketch of the demand shape.
    # the real simulator still adds randomness around it.
    ...
    for step in range(steps_per_day):
        ...
        # A->C and C->A pass both stations, so i just split them evenly here
