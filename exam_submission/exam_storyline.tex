...
\texttt{RUN\_DEMO\_TRAINING\ =\ True} in this cell.

\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{/Library/Frameworks/Python.framework/Versions/3.11/bin/python3.11} \AttributeTok{{-}m}\NormalTok{ evch.train.train\_rl }\AttributeTok{{-}{-}config}\NormalTok{ reference\_code/configs/env/mobile\_mcs\_line\_abc.yaml }\AttributeTok{{-}{-}config}\NormalTok{ reference\_code/configs/demand/base.yaml }\AttributeTok{{-}{-}config}\NormalTok{ reference\_code/configs/rl/dqn\_mobile\_simple.yaml }\AttributeTok{{-}{-}config}\NormalTok{ reference\_code/configs/debug/logging\_disabled.yaml }\AttributeTok{{-}{-}config}\NormalTok{ reference\_code/configs/experiment/mobile\_mcs\_line\_abc\_train\_only.yaml }\AttributeTok{{-}{-}config}\NormalTok{ reference\_code/configs/demo/mobile\_mcs\_line\_abc\_demo\_short.yaml}
\end{Highlighting}
\end{Shaded}
